    ...
    <footer className={styles.footerRoot}>
      <section className={`${styles.contactSection} fluid-px`}>
        ...
        <div className={styles.contactInfo}>
          <a className={`${styles.contactItem} fluid-body`} href="tel:+919876543210" target="_blank" rel="noopener noreferrer">
          ...
          <a className={`${styles.contactItem} fluid-body`} href="https://maps.google.com/?q=Chennai, India" target="_blank" rel="noopener noreferrer">
            <span className={styles.icon}>
          ...
          <a className={`${styles.contactItem} fluid-body`} href="https://instagram.com/aereleerp" target="_blank" rel="noopener noreferrer">
            <span className={styles.icon}>
          ...
          <a className={`${styles.contactItem} fluid-body`} href="mailto:contact@aerele.com" target="_blank" rel="noopener noreferrer">
            <span className={styles.icon}>
