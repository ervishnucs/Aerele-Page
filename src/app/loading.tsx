export default function Loading() {
  return (
    <div className="min-h-[60vh] w-full flex flex-col items-center justify-center px-6 md:px-16 py-16 animate-pulse">
      ...
      <div className="h-4 w-full max-w-2xl bg-gray-200 rounded mb-4" />
      <div className="h-4 w-full max-w-xl bg-gray-200 rounded mb-10" />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="h-40 bg-gray-200 rounded border-4 border-[#032148]" />
        <div className="h-40 bg-gray-200 rounded border-4 border-[#032148]" />
        <div className="h-40 bg-gray-200 rounded border-4 border-[#032148]" />
      </div>
    </div>
